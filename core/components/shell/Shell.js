...
Shell.prototype.center = function (){
	var th = this.height;
	var tw = this.width;
...
Shell.prototype.moveToFirst = function (){
	var max = 0;
...
Shell.prototype.prepareAll = function (){
	var __this = this;
...
Shell.prototype.setDefaults = function (dom) {
...
Shell.prototype.toggleFs = function () {
	var dom = $(this.html);
...
Shell.prototype.minimize = function () {
	var dom = this.html;
...
Shell.prototype.restore = function () {
	var dom = this.html;
...
Shell.prototype.getInput = function () {
	return this._input.text();
}

Shell.prototype.clearInput = function () {
	this._input.text('');
}

Shell.prototype.processInput = function (e) {
...
Shell.prototype.enterCommand = function (command) {
	this.currHistPos = 0;
	this.hus = false;
	this.clearInput();
...
Shell.prototype.saveCommand = function (command) {
...
Shell.prototype.historyUp = function () {
...
Shell.prototype.historyDown = function () {
	if(isset(this._history[this.currHistPos + -1])){
		var pos = --this.currHistPos;
		var cm = this._history[pos];
		if(cm) {
...
Shell.prototype.updatePath = function (back) {
	var pattern = /(\~\/[^ \$](.*?\/)+)|(~\/.*?)/gi;
...
Shell.prototype.updatePathUser = function (user) {
	var pattern = /^(.*?)@+/;
	var pt = this._path.text();
...
Shell.prototype.hidePath = function () {
	this._path.hide();
}

Shell.prototype.showPath = function () {
	this._path.show();
}

Shell.prototype.startShellProgram = function (options) {
...
Shell.prototype.useRunningProcess = function (name) {
